...
mdb.models['Model-1'].materials['Material-Powder'].Depvar(n=2)
...
mdb.Job(model='Model-1', name=jobName, numCpus=20, numDomains=20, userSubroutine=os.path.realpath("umatht_dflux.for") )
